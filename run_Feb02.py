...
if __name__ == "__main__":
    ...
    for crop1_size in crop1_sizes:
        for crop2_range in crop2_ranges[crop1_size]:
            cfg.crop1_size = crop1_size
            cfg.crop2_range = crop2_range
            ...
            neptune.create_experiment(name=model_prefix, params=params_dict, upload_source_files=['*.py', 'leaf/*.py', 'environment.yml'],
                                      description="Testing cropping augmentations")
