...
if __name__ == "__main__":
    ...
    params_dict = {
        param: eval(param) for param in ["arch", "img_size", "train_transforms", "val_transforms", "batch_size", "num_epochs", "warmup_epochs", "cosine_epochs", "min_lr", "max_lr", "weight_decay", "optimizer", "scheduler_warmup", "grad_norm"]
    }
